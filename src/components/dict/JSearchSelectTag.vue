  ...
  export default {
    ...
    methods:{
      ...
      handleAsyncChange(selectedObj){
        //update-begin-author:scott date:20201222 for:【搜索】搜索查詢組件，刪除條件，默認下拉還是上次的緩存數據，不好 JT-191
        if(selectedObj){
        ...
        this.callback()
        //update-end-author:scott date:20201222 for:【搜索】搜索查詢組件，刪除條件，默認下拉還是上次的緩存數據，不好 JT-191
      },
      callback(){
