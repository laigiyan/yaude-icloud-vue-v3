<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('资源用量表')">导出</a-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'date',value:'usageDate',text:'统计时间'})
        fieldList.push({type:'int',value:'ram',text:'内存用量',dictCode:''})
        fieldList.push({type:'BigDecimal',value:'totalVcpusUsage',text:'周期内CPU-小时数',dictCode:''})
        fieldList.push({type:'BigDecimal',value:'totalLocalGbUsage',text:'周期内磁盘GB-小时数',dictCode:''})
