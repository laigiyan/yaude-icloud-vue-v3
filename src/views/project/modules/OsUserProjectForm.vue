  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
           userId: [
              { required: true, message: '请输入用戶ID!'},
           ],
           projectId: [
              { required: true, message: '请输入項目ID!'},
           ],
        },
        url: {
