<template>
  <a-card>
    <draggable @end="end" :options="{animation: 300}" v-model="dataSource" style="display: inline-block">
      ...
      <a-button @click="sureChange" type="primary" style="margin-top: 115px">確定</a-button>
    </draggable>
    <br/>
    <a-row>
      <a-col :span="12">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        dataSource: [
          ...
          {id:'333',sort: 3,filePath: 'https://static.jeecg.com/temp/國炬軟件logo_1606575029126.png'},
    ...
    methods:{
        ...
        console.log("拖動前的位置"+evt.oldIndex);
        console.log("拖動後的位置"+evt.newIndex);
      },
      sureChange(){
