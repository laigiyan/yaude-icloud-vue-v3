...
<script>
  ...
  export default {
    ...
    // 監聽器
    watch: {
      // 監聽table1 左上【主表】選擇的數據發生了變化
      ['table1.lastRow']() {
        this.loadTable2Data()
      },
      // 監聽table3 右上【主表】選擇的數據發生了變化
      ['table3.lastRow']() {
        this.loadTable4Data()
      },
