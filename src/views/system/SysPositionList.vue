<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="職務編碼">
              <a-input placeholder="請輸入職務編碼" v-model="queryParam.code"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="職務名稱">
              <a-input placeholder="請輸入職務名稱" v-model="queryParam.name"></a-input>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="職級">
                <j-dict-select-tag v-model="queryParam.postRank" placeholder="請選擇職級" dictCode="position_rank"/>
              </a-form-item>
            </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('職務表')">導出</a-button>
