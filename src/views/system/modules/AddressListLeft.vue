<template>
  <a-card :loading="cardLoading" :bordered="false" style="height: 100%;">
    <a-spin :spinning="loading">
      <a-input-search @search="handleSearch" style="width:100%;margin-top: 10px" placeholder="輸入機構名稱查詢..." enterButton />
      ...
      commonRequestThen(promise) {
        ...
        promise.then(res => {
          if (res.success) {
            ...
            // update-begin- --- author:wangshuai ------ date:20200102 ---- for:去除默認選中第一條數據、默認展開所有第一級
            // 默認選中第一條數據、默認展開所有第一級
            ...
            //   })
            // }
           // update-end- --- author:wangshuai ------ date:20200102 ---- for:去除默認選中第一條數據、默認展開所有第一級
          } else {
            this.$message.warn(res.message)
            console.error('組織機構查詢失敗:', res)
          }
        }).finally(() => {
          this.loading = false
